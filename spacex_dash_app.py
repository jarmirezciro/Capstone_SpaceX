...
# Reading CSV file and creating a data frame with data

#Saving the max and min load from the data frame
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # Adding step size=1000, and labels for the step size
...
#Creting the fuction scatter
def scatter(site_dropdown):
